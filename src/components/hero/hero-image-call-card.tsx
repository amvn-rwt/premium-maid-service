...
export function HeroImageCallCard() {
  return (
    <div className="rounded-xl bg-foreground p-3.5 shadow-[0_16px_48px_-10px_rgba(26,33,31,0.45)] ring-1 ring-inset ring-white/10 sm:p-4">
      <p className="text-[11px] leading-snug font-medium text-background/55 sm:text-xs">
