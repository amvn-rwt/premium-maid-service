...
export function SiteLogo({ className = "", inverted = false }: SiteLogoProps) {
  ...
  return (
    <Link
      ...
      className={`group inline-block min-w-0 max-w-48 leading-snug tracking-normal transition-opacity hover:opacity-90 sm:max-w-none sm:leading-tight ${className}`}
    >
      <span className="block text-lg sm:whitespace-nowrap">
