...
description: >-
  Client discovery workflow for Premium Maid Service. Use when processing client
  answers, preparing discovery questions, updating docs/PROJECT_BRIEF.md, or
  locking open decisions D1–D10.
---

# Client Discovery

## When client shares answers

1. Update `docs/PROJECT_BRIEF.md`:
   - Section 2 (Open decisions): change status from Pending to confirmed value
   - Section 8 (Content checklist): check off received items
   - Section 13: add dated note with source (e.g. WhatsApp, call)
   - Document history table at bottom
...
- **Business & operations**: areas served, hiring flow, fees, replacement, response time
...
Summarize what was locked, what remains pending, and suggest 2–3 next questions to send on WhatsApp.
