...
Reply with the question number and your answer, e.g. `3. Email: …` or `7a. Yes, police verified`.
...
**10.** Legal / registered business name (if different from "Premium Maid Service"):

`_________________________`

**11.** One-line tagline for the footer (or we'll draft one):

`_________________________`

*Example: "Trusted domestic help for Delhi NCR homes"*

**12.** How long has Premium Maid Service been operating?

`_________________________`

*(We'll only show this on the site if you want.)*
...
*Example: Enquiry → shortlist → interview at home → placement*

**15.** Average **response time** after an enquiry (e.g. "within 2 hours", "same day"):
...
**21.** Any **training or certifications** (e.g. Skill India)?
...
## E. Services (help us write accurate descriptions)

For each service, tell us what you actually offer. Tick all that apply.

**24. All-rounder maid**

- [ ] Full-time  [ ] Part-time  [ ] Live-in  [ ] 24-hour
- Anything else to mention: `_________________________`

**25. Cooking maid**

- [ ] Veg only  [ ] Non-veg  [ ] Both
- Cuisines: [ ] North Indian  [ ] South Indian  [ ] Other: `________`
...
**29.** Any other services now or soon? (Elderly care, patient care, driver, etc.)

`_________________________`

**30.** Specific **areas within Delhi NCR** you serve (for SEO and form dropdown):

*e.g. South Delhi, Gurgaon, Noida, Dwarka…*
...
**40.** What are your charges / agency fees?
...
**42.** What if the maid doesn't work out?

`_________________________`

**43.** How quickly can you provide a maid?
...
**44.** Do you already have a **domain name** (e.g. premiummaidservice.in)?

`_________________________`

**45.** Target **go-live date** (rough is fine):
...
**47.** Anything else you want on the website that we haven't asked?
...
| Date | Change |
|------|--------|
| 2026-06-19 | Initial questionnaire created |
